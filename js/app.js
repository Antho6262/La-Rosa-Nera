    ...
    <div class="shell">
      <aside class="sidebar">
        <div class="sidebar-head">
          <img src="${root}img/logo.png" alt="La Rosa Nera" class="sidebar-coin">
          <div class="sidebar-logo"><span class="full">LA ROSA NERA</span></div>
        </div>
      ...
      <div class="main">
        <div class="topbar">
          ...
          <div class="topbar-brand"><span class="coin">🪙</span> LA ROSA NERA</div>
        </div>
